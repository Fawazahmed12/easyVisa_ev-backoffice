 ...
 * Question: (Q_2767) What is the secondary address description?
 *           (Q_2768) Apartment/Suite/Floor
 *
...
@Component
class AutoSyncChildLiveWithBeneficiaryAddressDescriptionValidationRule implements IAnswerVisibilityValidationRule {

    private static String RULE_NAME = 'AutoSyncChildLiveWithBeneficiaryAddressDescriptionValidationRule'
    ...
    Boolean validateAnswerVisibility(NodeRuleEvaluationContext ruleEvaluationContext) {
        ...
        String SECONDARY_ADDRESS_DESCRIPTION_PATH = "${ruleParams[1]}/${repeatingIndex}";
        ...
        String isChildLiveWithBeneficiaryAddressSameAsPhysicalAddress = EasyVisaNode.normalizeAnswer(secondaryAddressDescriptionAnswer.getValue())
