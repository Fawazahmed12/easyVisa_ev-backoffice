...
@Component
class AutoPopulatePhysicalAddressAbroadRule extends BaseComputeRule {

    private static String RULE_NAME = "AutoPopulatePhysicalAddressAbroadRule";
    ...
    private Map<String, String> getFieldTransferMapper(NodeRuleEvaluationContext nodeRuleEvaluationContext) {
        ...
        fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2003'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2076';
        fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2004'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2077';
        fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2005'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2078';
        fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2006'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2079';
        fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2007'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2080';
        if(!this.evaluateEmployerCountrySelectionRule(nodeRuleEvaluationContext)) {
            // Country
            fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2002'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2075';
            //Province/State/Territory/Prefecture/Parish  to  Province/State/Territory/Prefecture/Parish
            fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2009'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2081';
            //Postal Code  to  Postal Code
            fieldsToTransfer['Sec_addressHistoryForBeneficiary/SubSec_currentPhysicalAddressForBeneficiary/Q_2011'] = 'Sec_addressHistoryForBeneficiary/SubSec_physicalAddressAbroadForBeneficiary/Q_2082';
        }
