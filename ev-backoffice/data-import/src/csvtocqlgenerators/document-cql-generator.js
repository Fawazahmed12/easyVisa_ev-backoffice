...
function generateCqlCommands(parsedData, cqlNodeName, questionnaireDataType) {
    var documentColumnData = {
        ...
        "Description": {'columnIndex': -1, 'modelName': "description"}
    };
    return cqlGeneratorUtil.generateCqlCommands(documentColumnData, parsedData, cqlNodeName, questionnaireDataType);
}
