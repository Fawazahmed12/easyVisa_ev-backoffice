...
@Component
class EmploymentAuthorizationSSADependentApplicableRule extends BaseComputeRule {

    private static String RULE_NAME = "EmploymentAuthorizationSSADependentApplicableRule"
    ...
    private Boolean evaluateEmploymentAuthorizationSSAApplicableRule(NodeRuleEvaluationContext ruleEvaluationContext) {
        ...
        if (!Answer.isValidAnswer(ssaAnswer)) {
            return false;
        }
