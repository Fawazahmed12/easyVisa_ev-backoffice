 ...
 * Question: (Q_73) What is the secondary address description?
 *           (Q_74) Apartment/Suite/Floor
 *
...
@Component
class CurrentMailingAddressDescriptionValidationRule implements IAnswerVisibilityValidationRule {

    private static String RULE_NAME = 'CurrentMailingAddressDescriptionValidationRule'
